...
namespace Detectors.UI.Controls
{
    public partial class DownloadOptions
	{
		...
		public static readonly DependencyProperty CAPACITY_PROPERTY = DependencyProperty.Register("Capacity", typeof(bool), typeof(DownloadOptions), new UIPropertyMetadata(false , new PropertyChangedCallback(OnOptionChanged)));
        ...
        public bool Capacity { get => (bool)GetValue(CAPACITY_PROPERTY); set => SetValue(CAPACITY_PROPERTY, value); }
